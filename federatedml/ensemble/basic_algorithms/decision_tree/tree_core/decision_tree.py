...
class DecisionTree(BasicAlgorithms):
    ...
    @staticmethod
    def get_grad_hess_sum(grad_and_hess_table) -> Tuple[DTable, DTable]:
    ...
    def set_grad_and_hess(self, grad_and_hess: DTable):
        self.grad_and_hess = grad_and_hess

    def set_input_data(self, data_bin: DTable, bin_split_points, bin_sparse_points):

        self.data_bin = data_bin
        self.bin_split_points = bin_split_points
        self.bin_sparse_points = bin_sparse_points

    def get_local_histograms(self, node_map):
    ...
    @ staticmethod
    def assign_instance_to_root_node(data_bin: DTable, root_node_id):
