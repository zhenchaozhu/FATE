...
# source: boosting_core-tree-model-param.proto
...
_DECISIONTREEMODELPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='node_plan', full_name='com.webank.ai.fate.core.mlmodel.buffer.DecisionTreeModelParam.node_plan', index=3,
...
_BOOSTINGTREEMODELPARAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tree_plan', full_name='com.webank.ai.fate.core.mlmodel.buffer.BoostingTreeModelParam.tree_plan', index=9,
