...
class Boosting(ModelBase):
    def __init__(self):
        ...
        LOGGER.debug('boosting_core tree para is {}'.format(self.model_param))
    ...
    def _init_model(self, boostingtree_param: BoostingTreeParam):
        ...
        self.work_mode = boostingtree_param.work_mode
        self.k = boostingtree_param.k
        self.guest_depth = boostingtree_param.guest_depth
        self.host_depth = boostingtree_param.host_depth
