        ...
        for i in range(self.num_trees):
            ...
            if validation_strategy:
                ...
                if self.early_stopping_rounds > 0:
                    ...
                    should_stop = validation_strategy.check_early_stopping(self.early_stopping_rounds)

                    if should_stop:
                        LOGGER.info('early stopping condition satisfied')
            ...
            if self.n_iter_no_change or (self.early_stopping_rounds > 0 and validation_strategy is not None):
                # if pass the n_iter_no_change and early stopping check above, send false flag
