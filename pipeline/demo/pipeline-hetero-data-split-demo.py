...
hetero_data_split_0 = HeteroDataSplit(name="hetero_data_split_0", stratified=False, test_size=0.3)

print ("get input_0's name {}".format(input_0.name))
pipeline.add_component(dataio_0, data=Data(data=input_0.data))
pipeline.add_component(intersect_0, data=Data(data=dataio_0.output.data))
pipeline.add_component(hetero_data_split_0, data=Data(train_data=intersect_0.output.data))
...
print (pipeline.get_component("hetero_data_split_0").get_model_param())
